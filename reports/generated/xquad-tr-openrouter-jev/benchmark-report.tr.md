...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| tr | A | 5 | 0.800 | 0.800 | 0.000 | 0.242 | 1254.2 | 1475.1 | 0.000049 | 0.000 |
| tr | D | 5 | 0.800 | 0.800 | 0.000 | 0.253 | 1897.6 | 1980.4 | 0.000438 | 0.000 |

## Cevap desteği ve hata davranışı

| Dil | Kol | Kaynakta altın cevap | Geçerli atıf | Yanıtsız | Yanlış cevap |
|---|---:|---:|---:|---:|---:|
| tr | A | 0.800 | 0.800 | 0.400 | 1.000 |
| tr | D | 0.800 | 0.800 | 0.200 | 1.000 |

## Gecikme kırılımı

| Dil | Kol | Retrieval p50/p95 ms | Reranking p50/p95 ms | Generation p50/p95 ms | Uçtan uca p50/p95 ms |
|---|---:|---:|---:|---:|---:|
| tr | A | 0.8/2.1 | 0.0/0.0 | 1251.9/1473.9 | 1254.2/1475.1 |
| tr | D | 0.8/2.1 | 516.7/681.3 | 1177.2/1485.8 | 1897.6/1980.4 |

## Maliyet

- Toplam ölçülen çevrimiçi deney gideri: **$0.002433**.
- Reranking API gideri: **$0.001905**; cevap üretimi API gideri: **$0.000527**.
- Bir defalık indeksleme süresi: **5.3 ms**; API gideri: **$0**.
- Başarılı cevap tanımı: `F1 >= 0.5`; başarılı cevap sayısı: **1**.
- Başarılı cevap başına ölçülen çevrimiçi gider: **$0.002433**.
- `tr-A`: $0.000049/sorgu (rerank $0.000000 + üretim $0.000049); $0.0490/1000 sorgu.
- `tr-D`: $0.000438/sorgu (rerank $0.000381 + üretim $0.000056); $0.4375/1000 sorgu.

## Eşleştirilmiş bootstrap (%95 GA)

- `tr` A→D nDCG@10 farkı: **+0.000** (GA +0.000, +0.000; n=5).
